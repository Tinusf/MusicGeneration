...
def convert_to_midi(prediction_output):
    ...
    for pattern in prediction_output:
        ...
        while pattern != "":
            ...
            if ('.' in current_notes) or current_notes.isdigit():
                ...
                for current_note in notes_in_chord:
                    ...
                    pattern_notes.append(cur_instrument)
                    pattern_notes.append(new_note)
        ...
        #     new_chord = chord.Chord(pattern_notes[1::2])
        #     new_chord.offset = offset
        #     instruments = pattern_notes[0::2]
        #     # all_similar = True
        #     # for i in range(len(instruments) - 1):
        #     #     if str(instruments[i]) != str(instruments[i + 1]):
        #     #         all_similar = False
        #     # if all_similar:
        #         # Then we can append the instrument.
        #
        #     # TODO: This doesn't work because you cannot have multiple instruments in one chord it seems.
        #     # output_notes.append(pattern_notes[0])
        #     output_notes.append(new_chord)
        # else:
        #     # extend?
        #     for _note in pattern_notes:
        #         output_notes.append(_note)

        offset += 1
    # hmm
    output_notes = output_notes.chordify()
    p1 = stream.Part()
